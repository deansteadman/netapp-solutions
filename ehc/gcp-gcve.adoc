...
[.lead]
Learn more about the capabilities that NetApp brings to Google Cloud VMware Engine (GCVE) - from NetApp as a guest connected storage device or a supplemental NFS datastore to migrating workflows, extending/bursting to the cloud, backup/restore and disaster recovery.
...
[[solutions]]
== Solution Use Cases
With NetApp and VMware cloud solutions, many use cases are simple to deploy in Google Cloud VMware Engine. Use cases are defined for each of the VMware defined cloud areas:
