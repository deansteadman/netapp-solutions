...
summary: Customers who currently use Veeam for their data protection requirements continue using that solution to migrate the workloads to GCVE and enjoy the benefits of NetApp Google Cloud NetApp Volumes NFS Datastores.
---
...
If not, Please refer link:gcp-ncvs-datastore.html[Mount Google Cloud NetApp Volumes as NFS datastore on GCVE] 
